...
var zeroesAndOnes = function(str) {
    ...
    console.log((strMap));
    //Checks if string contains more than two types of characters. String should only contain 0's and 1's and therefore the length of the ensuing array should be no greater than 2.
